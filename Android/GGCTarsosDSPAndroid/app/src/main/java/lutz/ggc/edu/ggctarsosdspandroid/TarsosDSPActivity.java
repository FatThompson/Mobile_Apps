...
public class TarsosDSPActivity extends AppCompatActivity {
	...
	public void displayPitch(float pitch){
		...
		else if (  25.23  <=     pitch && pitch <  26.73  ) { letter = "A"; flat = " \u266D "; oct = " 0  " ; }
		else if (  26.73  <=     pitch && pitch <  28.32  ) { letter = "A"; flat = "    "; oct = " 0  " ; }
		else if (  28.32  <=     pitch && pitch <  30.01  ) { letter = "B"; flat = " \u266D "; oct = " 0  " ; }
		else if (  30.01  <=     pitch && pitch <  31.79  ) { letter = "B"; flat = "    "; oct = " 0  " ; }
		...
		else if (  50.46  <=     pitch && pitch <  53.46  ) { letter = "A"; flat = " \u266D "; oct = " 1  " ; }
		else if (  53.46  <=     pitch && pitch <  56.64  ) { letter = "A"; flat = "    "; oct = " 1  " ; }
		else if (  56.64  <=     pitch && pitch <  60.01  ) { letter = "B"; flat = " \u266D "; oct = " 1  " ; }
		else if (  60.01  <=     pitch && pitch <  63.58  ) { letter = "B"; flat = "    "; oct = " 1  " ; }
		...
		else if (  100.92 <=     pitch && pitch <  106.92 ) { letter = "A"; flat = " \u266D "; oct = " 2  " ; }
		else if (  106.92 <=     pitch && pitch <  113.27 ) { letter = "A"; flat = "    "; oct = " 2  " ; }
		else if (  113.27 <=     pitch && pitch <  120.01 ) { letter = "B"; flat = " \u266D "; oct = " 2  " ; }
		else if (  120.01 <=     pitch && pitch <  127.14 ) { letter = "B"; flat = "    "; oct = " 2  " ; }
		...
		else if (  201.83 <=     pitch && pitch <  213.83 ) { letter = "A"; flat = " \u266D "; oct = " 3  " ; }
		else if (  213.83 <=     pitch && pitch <  226.54 ) { letter = "A"; flat = "    "; oct = " 3  " ; }
		else if (  226.54 <=     pitch && pitch <  240.01 ) { letter = "B"; flat = " \u266D "; oct = " 3  " ; }
		else if (  240.01 <=     pitch && pitch <  254.29 ) { letter = "B"; flat = "    "; oct = " 3  " ; }
		...
		else if (  403.65 <=     pitch && pitch <  427.65 ) { letter = "A"; flat = " \u266D "; oct = " 4  " ; }
		else if (  427.65 <=     pitch && pitch <  453.08 ) { letter = "A"; flat = "    "; oct = " 4  " ; }
		else if (  453.08 <=     pitch && pitch <  480.02 ) { letter = "B"; flat = " \u266D "; oct = " 4  " ; }
		else if (  480.02 <=     pitch && pitch <  508.57 ) { letter = "B"; flat = "    "; oct = " 4  " ; }
		...
		else if (  1614.60    <=     pitch && pitch <  1710.61    ) { letter = "A"; flat = " \u266D "; oct = " 6  " ; }
		else if (  1710.61    <=     pitch && pitch <  1812.33    ) { letter = "A"; flat = "    "; oct = " 6  " ; }
		else if (  1812.33    <=     pitch && pitch <  1920.10    ) { letter = "B"; flat = " \u266D "; oct = " 6  " ; }
		else if (  1920.10    <=     pitch && pitch <  2034.27    ) { letter = "B"; flat = "    "; oct = " 6  " ; }
		...
		else if (  3229.20    <=     pitch && pitch <  3421.22    ) { letter = "A"; flat = " \u266D "; oct = " 7  " ; }
		else if (  3421.22    <=     pitch && pitch <  3624.66    ) { letter = "A"; flat = "    "; oct = " 7  " ; }
		else if (  3624.66    <=     pitch && pitch <  3840.19    ) { letter = "B"; flat = " \u266D "; oct = " 7  " ; }
		else if (  3840.19    <=     pitch && pitch <  4068.54    ) { letter = "B"; flat = "    "; oct = " 7  " ; }
		...
		else if (  6458.41    <=     pitch && pitch <  6842.44    ) { letter = "A"; flat = " \u266D "; oct = " 8  " ; }
		else if (  6842.44    <=     pitch && pitch <  7249.31    ) { letter = "A"; flat = "    "; oct = " 8  " ; }
		else if (  7249.31    <=     pitch && pitch <  7680.38    ) { letter = "B"; flat = " \u266D "; oct = " 8  " ; }
